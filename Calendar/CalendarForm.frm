...
Private SelectedMeeting As String
...
Public Function GetDate(Optional SelectedDate As Date = 0, _
    ...
    Optional TodayFontColor As Long = 15773696) As Variant
    ...
    Me.Show
    GetDate = Array(DateOut, SelectedMeeting)
    Unload Me
End Function
...
Private Sub InitializeUserform(SelectedDate As Date, MinimumDate As Date, MaximumDate As Date, _
    ...
    Call CreateColumnReferenceArray
    cbMeetingsCal.List = Meetings
...
Private Sub cbMeetingsCal_Change()
...
Private Sub cmdToday_Click()
    ...
    DateOut = SelectedDateIn
    SelectedMeeting = cbMeetingsCal.value
    Me.Hide
